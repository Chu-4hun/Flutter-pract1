abstract class DataBaseRequest {
  ...
  static const String tableSupply = 'supply';
  ...
  static const String _createTableDelivery =
      'CREATE TABLE "$tableDelivery"  ( id integer NOT NULL, date date NOT NULL, user_id integer NOT NULL, product_id integer NOT NULL, PRIMARY KEY (id), CONSTRAINT cancellation_product_id_product_id_foreign FOREIGN KEY (product_id) REFERENCES "$tableProduct" (id), CONSTRAINT cancellation_user_id_user_id_foreign FOREIGN KEY (user_id) REFERENCES "$tableUser" (id));';

  /// Запрос для создания таблицы supply
  static const String _createTableSupply =
      'CREATE TABLE "$tableSupply"  ( id integer NOT NULL, date date NOT NULL, user_id integer NOT NULL, product_id integer NOT NULL, PRIMARY KEY (id), CONSTRAINT supply_product_id_product_id_foreign FOREIGN KEY (product_id) REFERENCES "$tableProduct" (id), CONSTRAINT supply_user_id_user_id_foreign FOREIGN KEY (user_id) REFERENCES "$tableUser" (id));';
}
